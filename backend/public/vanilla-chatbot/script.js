// Se borró el DOMLoaded
const BACKEND_URL = window.location.origin;
const LOGO_URL = '../Escudo_Unison.png';

// Crear estilos
const style = document.createElement("style");
style.textContent = `
/* Reset específico para contrarrestar Tailwind sin afectar estilos propios del chatbot */
.chatbot, .chatbot * {
/* Solo anular estilos específicos de Tailwind que causan problemas */
  box-sizing: border-box !important;
}

/* Restaurar estilos de lista específicamente */
...
/* Restaurar otros elementos HTML comunes */
.chatbot p {
  margin: 1em 0 !important;
}
