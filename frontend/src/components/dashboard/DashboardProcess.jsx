/**
 * DashboardProcess component
 *
 * Displays a dashboard section for viewing question counts by process, with date filtering and chart type selection.
 * Fetches and displays process count data, handles loading and error states, and shows toast notifications.
 *
 * Features:
 *   - Date range filtering and chart type selection via DatesFiltersAndSelects
 *   - Displays total questions and a chart (bar, pie, etc.) for process data
